...
import {
  AnalyticsKpi, AnalyticsPayload, fetchAnalytics, fmt,
} from "../api/client";
...
export default function Analytics() {
  ...
  if (loading || !data) return <div className="page-loading">Loading analytics…</div>;
  ...
  return (
    <div className="page">
      <div className="page-header">
        <div>
          <h1>Analytics</h1>
          <div className="page-subtitle">Trends, top sellers, and who owes whom.</div>
        </div>
      </div>
      ...
      <div className="charts-grid charts-grid-2">
        <PartyList
          title="Vendors you owe"
          empty="All caught up with vendors."
